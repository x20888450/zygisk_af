...
namespace KittyMemory {
    ...
    bool memWrite(void *address, const void *buffer, size_t len)
    {
        ...
        uintptr_t startAddress = addressMap.startAddress;
        uintptr_t endAddress = addressMap.endAddress;
        ...
        setAddressProtection((const void*)startAddress, size, addressMap.protection | PROT_WRITE);
        memcpy(address, buffer, len);
        setAddressProtection((const void*)startAddress, size, addressMap.protection);
        }
        return true;
    }
    // bool memWrite(void *address, const void *buffer, size_t len)
